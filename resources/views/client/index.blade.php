...
@section('content')
    ...
    <section class="section-event">
        <div class="wrap-slick2">
            <div class="slick2">
                <div class="item-slick2 item1-slick2" style="background-image: url(clientpage/images/bg-event-01.jpg);">
                ...
                <div class="item-slick2 item2-slick2" style="background-image: url(clientpage/images/bg-event-02.jpg);">
                    <div class="wrap-content-slide2 p-t-115 p-b-208">
                        <div class="container">
                            <!-- - -->
                            <div class="title-event t-center m-b-52">
                            ...
                            <div class="blo2 flex-w flex-str flex-col-c-m-lg animated visible-false"
                                ...
                                <a href="#" class="wrap-pic-blo2 bg2-blo2"
                                    style="background-image: url(clientpage/images/event-06.jpg);">
                                    <div class="time-event size10 txt6 effect1">
                ...
                <div class="item-slick2 item3-slick2" style="background-image: url(clientpage/images/bg-event-04.jpg);">
                    <div class="wrap-content-slide2 p-t-115 p-b-208">
                        <div class="container">
                            <!-- - -->
                            <div class="title-event t-center m-b-52">
                            ...
                            <div class="blo2 flex-w flex-str flex-col-c-m-lg animated visible-false"
                                ...
                                <a href="#" class="wrap-pic-blo2 bg3-blo2"
                                    style="background-image: url(clientpage/images/event-01.jpg);">
                                    <div class="time-event size10 txt6 effect1">
                                        <span class="txt-effect1 flex-c-m">
                                            08:00 PM Tuesday - 21 November 2018
                                        </span>
